...
> **📅 最後更新**: 2025年10月3日 - 索引維護自動化系統完整部署 + 項目索引完整性更新（添加39個遺漏文件，覆蓋率85%→100%）
...
| 組件名稱             | 文件路徑                                             | 用途說明                         | 代碼行數 | 重要程度 |
| -------------------- | ---------------------------------------------------- | -------------------------------- | -------- | -------- |
| **版本歷史列表**   | `components/knowledge/version/VersionHistoryList.tsx` | 知識庫文檔版本歷史展示         | ~300行   | 🔴 極高  |
| **版本差異對比**   | `components/knowledge/version/VersionDiffViewer.tsx`  | 知識庫版本差異並排對比         | ~350行   | 🔴 極高  |
| **版本回滾對話框** | `components/knowledge/version/VersionRestoreDialog.tsx` | 知識庫版本回滾確認             | ~250行   | 🔴 極高  |
