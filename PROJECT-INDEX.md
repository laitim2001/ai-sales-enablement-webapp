...
> **📅 最後更新**: 2025年10月5日 - Sprint 6-7完成後索引更新（添加26個文件，覆蓋率91.1%→100%）
> **🔍 使用方法**: AI 助手應首先查看此文件以了解項目結構和文件位置
>
> **✨ 最新添加**:
> - 🤝 協作系統 (Sprint 6): 編輯鎖定管理器 + API + UI組件
> - ⏰ 智能提醒系統 (Sprint 7 Phase 1): 規則引擎 + 調度器 + API + UI組件
> - 📊 用戶行為追蹤 (Sprint 7 Phase 1): 行為追蹤引擎 + 畫像生成 + API
> - 📅 會議準備包 (Sprint 7 Phase 1): 準備包管理器 + 模板系統 + API
...
### 📅 lib/meeting/ - 會議準備包系統 (Sprint 7 Phase 1完成)

**用途**: 智能會議準備包管理 - 自動組裝會議相關資料
...
| **統一導出**           | `lib/meeting/index.ts`                | 所有會議模組的統一導出入口                   | 15       | 🟡 高    |
